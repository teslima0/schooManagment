...
from .models import Attendance, Courses,CustomUser, AttendanceReport, FeedBackStaffs, LeaveReportStaff, Staffs, StudentResult, Students, Subjects, SessionYearModel
...
def staff_home(request):
    ...
    return render(request,"staff_template/staff_home_template.html",{'absent_list':student_list_attendance_absent,'present_list':student_list_attendance_present,'student_list':student_list,"subject_list":subject_list,"attendance_list":attendance_list,'subject_count':subject_count,"leave_count":leave_count,'students_count':students_count,"attendance_count":attendance_count})
...
def staff_profile(request):
    ...
    return render(request,"staff_template/staff_profile.html",{"users":user,"staff":staff})
...
def staff_add_result(request):
    subjects=Subjects.objects.filter(staff_id=request.user.id)
    session_years=SessionYearModel.object.all()
    return render (request,"staff_template/staff_add_result.html",{"session_years":session_years,"subjects":subjects})
