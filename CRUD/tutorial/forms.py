...
from .models import SessionYearModel, Subjects
...
class AddStudentForm(forms.Form):
    ...
    course=forms.ChoiceField(label="Course",choices=course_list,widget=forms.Select(choices=course_list,attrs={"class":"form-control"}))
...
class EditResultForm(forms.Form):
    ...
    subject_id=forms.ChoiceField(label="Subject", widget=forms.Select(attrs={'class': 'form-control'}))
        #session choice option is added in js
    ...
    exam_marks=forms.CharField(label="Examination Marks", widget=forms.TextInput(attrs={'class': 'form-control'}))