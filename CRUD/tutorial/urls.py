...
from .views import *
from tutorial import HodViews, StaffViews,StudentViews
urlpatterns = [
    path('demo',showDemoPage, name='homepage'),
    ...
    path('do_admin_signup',do_admin_signup,name="do_admin_signup"),
    path('Signup_staff',Signup_staff,name="signup_staff"),
    path('do_staff_signup',do_staff_signup,name="do_staff_signup"),
    path('Signup_student',Signup_student,name="signup_student"),
    path('do_student_signup',do_student_signup,name="do_student_signup"),
    ...
    path('add_session', SessionForm, name="add_session"),
